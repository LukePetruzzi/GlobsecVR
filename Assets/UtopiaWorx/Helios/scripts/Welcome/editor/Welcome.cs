...
namespace UtopiaWorx.Helios
{
	...
	public class Welcome : EditorWindow {
		...
		{
			EditorUtility.DisplayDialog("Install FFMPEG","This will take you to our Google Drive where you can download a copy of FFMPEG. Once you have downloaded it, import the .unitypackage into your project.","OK");
			Application.OpenURL("https://drive.google.com/file/d/0B7ycgD9eM7nycFN2dlpaZnJwdG8/view?usp=sharing");
