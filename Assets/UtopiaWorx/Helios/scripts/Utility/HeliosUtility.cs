...
namespace UtopiaWorx.Helios
{
	public class HeliosUtility : MonoBehaviour 
	{
		...
		public static string HeliosVersion  = "1.0.9";
		public static string VersionWarnings = "This version of Helios has introduced some new recording resolutions, please rebuild your resources by clicking Window/Helios/Rebuild Resources";
