...
// Helios 1.0.6
					...
					RenderTexture RTTemp = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
...
//Helios 1.0.6
					...
					RenderTexture RTTemp2 = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
...
//Helios 1.0.6
					...
					if(FlipWindows == true)
					{
						RenderTexture RTTemp3 = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
						Graphics.Blit(RTTemp2,RTTemp3,SourceMaterial,1);						
						RenderTexture.ReleaseTemporary(RTTemp2);

						RTTemp2 = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
					...
					if(AntiAliasingLevel > 0)
					{
						...
						RTTemp4 = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat,RenderTextureReadWrite.Default,AILvl);
					}
					else
					{
						RTTemp4 = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
					}
					Graphics.Blit(RTTemp2,RTTemp4);
					RenderTexture.ReleaseTemporary(RTTemp2);

					RenderTexture RTGrain = RenderTexture.GetTemporary(RecordResolutionX, RecordResolutionY * 2,0,RenderTextureFormat.ARGBFloat);
...
//Helios 1.0.6
						...
						RenderTexture RTTempR = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
						switch (ProjectionMode)
						{
						...
						RenderTexture RTTemp2R = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
						...
						if(FlipWindows == true)
						{
							RenderTexture RTTemp3R = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
							Graphics.Blit(RTTemp2R,RTTemp3R,SourceMaterial,1);						
							RenderTexture.ReleaseTemporary(RTTemp2R);

							RTTemp2R = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
						...
						if(AntiAliasingLevel > 0)
						{
							...
							RTTemp4R = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat,RenderTextureReadWrite.Default,AILvl);
						}
						else
						{
							RTTemp4R = RenderTexture.GetTemporary(RecordResolutionX,RecordResolutionY,0,RenderTextureFormat.ARGBFloat);
						}
						...
						RenderTexture RTMergeIn = RenderTexture.GetTemporary(RecordResolutionX, RecordResolutionY * 2,0,RenderTextureFormat.ARGBFloat);
						RenderTexture RTMerge = RenderTexture.GetTemporary(RecordResolutionX, RecordResolutionY * 2,0,RenderTextureFormat.ARGBFloat);
						...
						RTTemp4 = RenderTexture.GetTemporary(RecordResolutionX, RecordResolutionY * 2,0,RenderTextureFormat.ARGBFloat);
						...
						RenderTexture RTGrainR = RenderTexture.GetTemporary(RecordResolutionX, RecordResolutionY * 2,0,RenderTextureFormat.ARGBFloat);
...
//Helios 1.0.6
					...
					if(ProjectionMode == 2)
					{
						SaveFile = new Texture2D(RecordResolutionX,RecordResolutionY * 2,TextureFormat.RGBAFloat,false,true);
					}
					else
					{
						SaveFile = new Texture2D(RecordResolutionX,RecordResolutionY,TextureFormat.RGBAFloat,false,true);
					}
					#endif
					...
					System.IO.File.WriteAllBytes(OurTempSquareImageLocation(ActualFrame), TheBytes );
